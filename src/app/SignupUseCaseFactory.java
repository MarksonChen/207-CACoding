...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel, ClearViewModel clearViewModel, SignupUserDataAccessInterface userDataAccessObject, ClearController clearController) {
